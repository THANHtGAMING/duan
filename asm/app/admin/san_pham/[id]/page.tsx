...
const otp = {
  ...
  fetch(`http://localhost:3000/api/sanpham/${id}`, otp)
      .then(res => {
        if (!res.ok) throw new Error("Lỗi khi thêm sản phẩm");
        thongbaoRef.current!.innerHTML = "Sửa thành công!";
     ...
     return (
      ...
      <div className="max-w-4xl mx-auto bg-white p-10 rounded-2xl shadow-lg">
        <h2 className="text-3xl font-bold text-gray-800 mb-6">Sửa sản phẩm </h2>
        <form onSubmit={suasp}   className="grid grid-cols-1 md:grid-cols-3 gap-6">
  ...
  return (
    <option key={loai.id} value={loai.id}>
      {loai.ten_loai}
          ...
          <div className="col-span-1">
            <label className="block text-sm font-semibold mb-2 text-gray-700">Hình ảnh (URL)</label>
            <input
              type="text"
              name="hinh"
ref={hinhRef}
     defaultValue={sanpham.hinh}
                className="w-full border border-gray-300 p-3 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 text-black"
            />
          </div>
          ...
          <div className="col-span-3">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <div className="flex items-center gap-6">
                  <label className="text-gray-700">
                    <input ref={ahRef} defaultValue={sanpham.an_hien}  type="radio" name="an_hien" value="1" defaultChecked className="mr-2" />
                    Hiện
                  </label>
                  <label className="text-gray-700">
              ...
              <div>
                ...
                <div className="flex items-center gap-6">
                  <label className="text-gray-700">
                    <input ref={ttRef} defaultValue={sanpham.hot}  type="radio" name="hot" value="1" defaultChecked className="mr-2" />
                    Nổi bật
                  </label>
                  <label className="text-gray-700">
